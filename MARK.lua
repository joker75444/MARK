...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MARK.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MARKTEAM/Files_Boyka/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1166711147,1178865384,1033028167,1282382975,1488653639}   
...
if hash or SudoBot(msg) or DevMARKW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMARKW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1317966118) then  
var = true  
elseif tonumber(user_id) == tonumber(1166711147) then
var = true 
elseif tonumber(user_id) == tonumber(1178865384) then
var = true  
...
if tonumber(user_id) == tonumber(1166711147) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1178865384) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1282382975) then
...
MARK_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MARK_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MARK_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MARK_Msg = 'امبروطور التفاعل' 
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,0, 1, nil, './'..bot_id..'.json', '- عدد المجموعات التي في البوت { '..#list..'}')
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMARK(msg,data) -- بداية العمل
if msg then
...
SourceMARKr = '❈ اهلا عزيزي\n ❈ انا بوت اسمي '..Namebot..'\n ❈ اختصاصي حمايه المجموعات\n ❈ من تكرار والسبام والتوجيه والخ…\n ❈ لتفعيلي اتبع الاخطوات…↓\n ❈ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❈ [قناة سورس البوت](http://t.me/RISK_00)'
end 
send(msg.chat_id_, msg.id_, SourceMARKr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevMARKW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMARKW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,MARK_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❈' and DevMARKW(msg) then  
...
if text == 'تعطيل التواصل ❈' and DevMARKW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❈' and DevMARKW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❈' and DevMARKW(msg) then  
...
if text == 'ضع كليشه ستارت ❈' and DevMARKW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❈ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❈' and DevMARKW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❈ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❈' and DevMARKW(msg) then 
...
if text == 'تحديث السورس ❈' and DevMARKW(msg) then 
os.execute('rm -rf MARK.lua')
os.execute('wget https://raw.githubusercontent.com/MARKTEAM/MARK/master/MARK.lua')
send(msg.chat_id_, msg.id_,' ❈ تم تحديث السورس \n ❈ لديك اخر اصدار لسورس مارك\n ❈ الاصدار » { 1.3v}')
dofile('MARK.lua')  
end
if text == 'الاصدار ❈' and DevMARKW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❈ اصدار سورس مارك \n ❈ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❈' and DevMARKW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❈ [تحديثات البوت](t.me/RISK_00) \n ❈ [قناه السورس](t.me/RISK_00)')
end
if text == "ضع اسم للبوت ❈" and DevMARKW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❈ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❈' and DevMARKW(msg) then 
...
if text == 'المشتركين ❈' and DevMARKW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❈ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'المجموعات ❈' and DevMARKW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❈ المجموعات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❈") and DevMARKW(msg) then
...
if text == ("قائمه العام ❈") and DevMARKW(msg) then
...
if text == ("قائمه الكتم العام ❈") and DevMARKW(msg) then
...
if text=="اذاعه خاص ❈" and msg.reply_to_message_id_ == 0 and DevMARKW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل الان اذاعتك؟ \n ❈ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❈" and msg.reply_to_message_id_ == 0 and DevMARKW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل الان اذاعتك؟ \n ❈ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❈" and msg.reply_to_message_id_ == 0 and DevMARKW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل الان اذاعتك؟ \n ❈ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❈" and msg.reply_to_message_id_ == 0  and DevMARKW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❈" and msg.reply_to_message_id_ == 0  and DevMARKW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❈' and DevMARKW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❈" and DevMARKW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❈" and DevMARKW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❈  عدد المجموعات الان » { '..#group..' }'..MARKk..''..MARK..'\n❈  الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMARKW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevMARKW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMARKW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMARKW(msg) then
...
local MARK1_Msg = database:get(bot_id.."MARK1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MARK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if MARK_Msg and not Special(msg) then  
local MARK_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MARK_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMARKW(msg) then
send(msg.chat_id_, msg.id_,' ❈ عدد اعضاء المجموعة قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMARKW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMARKW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❈ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMARKW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❈ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❈" and DevMARKW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❈ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❈$") and DevMARKW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❈ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❈" and DevMARKW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❈" and DevMARKW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❈ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❈" and DevMARKW(msg) then  
...
database:sadd(bot_id.."MARK:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MARK:blocname"..msg.chat_id_)
...
if name_Boyka then 
names_Boyka = database:smembers(bot_id.."MARK:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."MARK:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MARK:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MARK:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MARK:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MARK:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Boykaa_new(Boyka1,Boyka2)
if Boyka2 and Boyka2.first_name_ then 
if Boyka2.first_name_:match("(.*)"..database:get(bot_id.."MARK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MARK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Boyka_nnn = database:get(bot_id.."MARK:nump"..msg.chat_id_) or 5
local Boyka_nnn2 = database:get(bot_id.."MARK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Boyka_nnn2) == tonumber(Boyka_nnn) or tonumber(Boyka_nnn2) > tonumber(Boyka_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MARK:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❈ عزيزي >>["..Boyka2.username_.."](https://t.me/"..(Boyka2.username_ or "pvv_v")..")\n❈ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MARK:teh"..msg.chat_id_).."} بجانب اسمك\n❈ عدد المحاولات المتبقيه {"..(tonumber(Boyka_nnn) - tonumber(Boyka_nnn2)).."}")
end
end
end
end
...
local MARKChengName = database:get(bot_id.."MARK:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MARKChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MARKChengName..']')
database:del(bot_id.."MARK:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MARKChengName ~= data.first_name_ then 
local Text = {
  "غيرت اسمك لي حد فضحك  😹",
"حلو اسمك الجديد/ج",
"اسمك الجديد خرااااا 😉",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."MARK:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MARKChengUserName = database:get(bot_id.."MARK:Cheng:UserName"..data.id_)
if not data.username_ then 
if MARKChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MARKChengUserName..']')
database:del(bot_id.."MARK:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MARKChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MARK:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MARKChengPhoto = database:get(bot_id.."MARK:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MARKChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MARK:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MARKChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MARK:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text =[[
* 𓆩 WELCOME YN SOURCE FLASH 𓆪 *
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السورس', url="t.me/FAQY4"},
},
{
{text = 'مطور السـورس', url="t.me/Q_Y_4"},
},
{
{text =  'مطور السـورس' , url="t.me/QpSSpQ"},
},
{
{text ='مطور السـورس ' , url="t.me/pabl0oooo"},
},
}
...
if text == 'رفع نسخه الاحتياطيه' and DevMARKW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevMARKW(msg) then    
dofile('MARK.lua')  
send(msg.chat_id_, msg.id_, ' ❈ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevMARKW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMARKW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevMARKW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevMARKW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMARKW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevMARKW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevMARKW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMARKW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevMARKW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevMARKW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevMARKW(msg) then
...
if text == 'الملفات' and DevMARKW(msg) then
t = ' ❈ ملفات السورس مارك ↓\nٴ↯━━━━━MARK━━━━━↯ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevMARKW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MARKTEAM/Files_Boyka/master/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMARKW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MARKTEAM/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMARKW(msg) then
...
if text == "مسح الملفات" and DevMARKW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❈ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMARKW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMARKW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_MARK(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_MARK, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_MARK, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❈ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'pvv_v')..')'
status  = '\n ❈ تم تنزيل العضو متناك في المجموعه\n ❈ قوم يا حبي البس البنطلون وروح اتناك في بيتكو'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ❈ تم مسح جميع الحتاتات')
end
...
local  statuss  = '\n ❈ تم رفع العضــو الحاته في المجموعة \n ❈ تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
status  = '\n ❈ تم تنزيل العضــو الحاته من المجموعة\n ❈ مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ❈ تم تنزيل جميع الخولات من المجموعة')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n ❈ قائمة خولات المجموعة \nٴ↯━━━━━MARK━━━━━↯\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❈ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'pvv_v')..')'
status  = '\n ❈ تم تنزيل كلب في المجموعه\n ❈ هات يابن المتناكه العضمه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل الجامدين' and Mod(msg) then
database:del(bot_id..'Hors:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❈ تم تنزيل جميع الجامدين بالمجموعة')
end
if text == ("تاك للجامدين") and Mod(msg) then
local list = database:smembers(bot_id..'Hors:User'..msg.chat_id_)
t = "\n ❈ قائمة جامدين المجموعة \nٴ↯━━━━━MARK━━━━━↯\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الجامده [@"..username.."]\n"
else
t = t..""..k.."» الجامده `"..v.."`\n"
end
end
...
---------
if text == ("رفع جامده") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❈ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'pvv_v')..')'
local  statuss  = '\n ❈ تم رفع حصان في المجموعة\n ❈ تعالي يا جامده انا تعبان  '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل جامده")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❈ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'pvv_v')..')'
status  = '\n ❈ تم تنزيل جامده من المجموعة\n ❈ تعالي بردو انا تعبان'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."MARK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MARK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❈ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MARK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MARK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MARK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MARK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❈ تم منع الكلمه مع التحذير")  
database:del(bot_id.."MARK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MARK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MARK1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MARK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❈ ارسل الكلمه الان")  
database:set(bot_id.."MARK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MARK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MARK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MARK1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MARK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MARK1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MARK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MARK1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MARK1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❈ قائمة المنع \nٴ↯━━━━━MARK━━━━━↯\n"
for k,v in pairs(list) do  
local MARK_Msg = database:get(bot_id.."MARK1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MARK_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevMARKW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❈ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevMARKW(msg) then
...
if text == 'تفعيل الاذاعه' and DevMARKW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMARKW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..MARK_Msg[math.random(#MARK_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMARKW(msg) then 
...
if text == ("مسح ردود المطور") and DevMARKW(msg) then 
...
if text == ("ردود المطور") and DevMARKW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❈ قائمة ردود المطور \nٴ↯━━━━━MARK━━━━━↯\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMARKW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevMARKW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevMARKW(msg) then   
...
if text == 'تعطيل المغادره' and DevMARKW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❈ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MARK')..') '
...
if text == "تنظيف المجموعة " and DevMARKW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,' ❈ عدد الكروبات الان » { '..#group..' }'..MARKk..''..MARK..'\n*- الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
-- vardump(data) 
MARKdx(msg.chat_id_, msg.id_, ' ❈ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❈ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❈ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❈ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevMARKW(msg) then
...
*❈م10 ◂ اوامر الاعضاء*
ٴ↯━━━━━MARK━━━━━↯
彡 .[JOKER ♕](https://t.me/a_j_o_k_e_r)➢ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '➊', callback_data="/h1"},{text = '⓶', callback_data="/h2"},{text = '③', callback_data="/h3"},
},
{
{text = '➃', callback_data="/h4"},{text = '⑤', callback_data="/h5"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(Chat_id, Msg_id,'◎ عذرا الاوامر هذا لا تخصك ') 
return false
end
local Teext =[[
*✶𝑾𝑬𝑳𝑪𝑶𝑴𝑬*
...
*✶قائمه المنع*
^~^~^~^~^~^~^~^
[𝘾𝙃](https://t.me/RISK_00)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝟙', callback_data="/help1"},{text = '𝟚', callback_data="/help2"},{text = '𝟛', callback_data="/help3"},
},
{
{text = '𝟜', callback_data="/help4"},{text = '𝟝', callback_data="/help5"},
},
{
...
send(msg.chat_id_, msg.id_, t..'ٴ❈ٴ↯━━━━━MARK━━━━━↯❈○ٴ\n❈ 彡 .[JOKER ♕](https://t.me/a_j_o_k_e_r)➢  ')
end
...
MARK = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MARK)
...
------------------------------------------------------------------------
local MARKAbot = database:get(bot_id.."MARK1:Add:Filter:Rp2"..text..result.chat_id_)   
if MARKAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❈ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❈ ["..MARKAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MARK1_Msg = database:get(bot_id.."MARK1:Add:Filter:Rp2"..text..result.chat_id_)   
if MARK1_Msg then    
send(msg.chat_id_, msg.id_," ❈ "..MARK1_Msg)
